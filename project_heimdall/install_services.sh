...
chmod 0440 /etc/sudoers.d/heimdall-maintenance /etc/sudoers.d/heimdall-recovery
...
systemctl enable heimdall.service heimdall-maintenance.service heimdall-ui.service heimdall-radio.service heimdall-recovery.service
...
echo
echo "Status:"
for svc in heimdall.service heimdall-maintenance.service heimdall-ui.service heimdall-radio.service heimdall-recovery.service; do
